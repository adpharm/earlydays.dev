import { c as createComponent, d as createAstro, r as renderComponent, b as renderTemplate, g as renderSlot, m as maybeRenderHead } from '../chunks/astro/server_lvFGk3__.mjs';
import 'kleur/colors';
import { $ as $$Layout } from '../chunks/Layout_Bho3Qsfk.mjs';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import * as React from 'react';
import { Slot } from '@radix-ui/react-slot';
import { ChevronRight, XIcon, PanelLeftIcon, ChevronsUpDown, Sparkles, BadgeCheck, CreditCard, Bell, LogOut, Command, SquareTerminal, Bot, BookOpen, Settings2 } from 'lucide-react';
import { c as cn } from '../chunks/utils_DWI7vIpo.mjs';
...
function TooltipContent({
  ...
  return /* @__PURE__ */ jsx(TooltipPrimitive.Portal, { children: /* @__PURE__ */ jsxs(
    TooltipPrimitive.Content,
    {
      ...
      children: [
        children,
        /* @__PURE__ */ jsx(TooltipPrimitive.Arrow, { className: "bg-zinc-900 fill-primary z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px] dark:bg-zinc-50" })
      ]
    }
  ) });
}
...
const clientConfig = { basePath: '/auth' };
...
function AppSidebar({ ...props }) {
  return /* @__PURE__ */ jsxs(Sidebar, { variant: "inset", ...props, children: [
    /* @__PURE__ */ jsx(SidebarHeader, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsx(SidebarMenuButton, { size: "lg", asChild: true, children: /* @__PURE__ */ jsxs("a", { href: "#", children: [
      /* @__PURE__ */ jsx("div", { className: "flex aspect-square size-8 items-center justify-center rounded-lg bg-sidebar-primary text-sidebar-primary-foreground", children: /* @__PURE__ */ jsx(Command, { className: "size-4" }) }),
      /* @__PURE__ */ jsxs("div", { className: "grid flex-1 text-left text-sm leading-tight", children: [
        /* @__PURE__ */ jsx("span", { className: "truncate font-semibold", children: "Acme Inc" }),
        /* @__PURE__ */ jsx("span", { className: "truncate text-xs", children: "Enterprise" })
      ] })
    ] }) }) }) }) }),
    /* @__PURE__ */ jsx(SidebarContent, { children: /* @__PURE__ */ jsx(AppSidebarNavMain, { items: data.navMain }) }),
    /* @__PURE__ */ jsx(SidebarFooter, { children: /* @__PURE__ */ jsx(AppSidebarNavUser, { user: data.user }) })
  ] });
}

function AppSidebarWrapper(_) {
  return /* @__PURE__ */ jsxs(SidebarProvider, { children: [
    /* @__PURE__ */ jsx(AppSidebar, {}),
    /* @__PURE__ */ jsxs(SidebarInset, { className: "flex flex-col min-h-screen", children: [
      /* @__PURE__ */ jsx("header", { className: "flex h-16 shrink-0 items-center gap-2", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 px-4", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "flex-1", children: _.children })
    ] })
  ] });
}

const $$Astro$1 = createAstro();
const $$LayoutWithAppSidebar = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$LayoutWithAppSidebar;
  const props = Astro2.props;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { ...props }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "AppSidebarWrapper", AppSidebarWrapper, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@/components/_/app-sidebar/AppSidebarWrapper", "client:component-export": "AppSidebarWrapper" }, { "default": ($$result3) => renderTemplate` ${renderSlot($$result3, $$slots["default"])} ` })} ` })}`;
}, "/workspace/src/components/_/layout/LayoutWithAppSidebar.astro", void 0);

const $$Astro = createAstro();
const $$Index = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Index;
  if (!Astro2.locals.session) return Astro2.redirect("/app/login");
  return renderTemplate`${renderComponent($$result, "LayoutWithAppSidebar", $$LayoutWithAppSidebar, { "title": "earlydays app" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div>Hello world</div> ` })}`;
}, "/workspace/src/pages/app/index.astro", void 0);

const $$file = "/workspace/src/pages/app/index.astro";
const $$url = "/app";
